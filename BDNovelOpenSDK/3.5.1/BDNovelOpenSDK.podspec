Pod::Spec.new do |s|
  ...
  s.dependency 'RangersAPM/Crash', '~> 2.4.0'
  s.dependency 'RangersAPM/HMD', '~> 2.4.0'
  s.dependency 'RangersAPM/Core', '~> 2.4.0'
  s.dependency 'RangersAPM/Public', '~> 2.4.0'
  s.dependency 'RangersAPM/CN', '~> 2.4.0'
